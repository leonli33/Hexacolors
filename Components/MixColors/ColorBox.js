...
class ColorBox extends Component {
  ...
  render() {
    ...
    let backColor =
      this.props.color === ""
        ? "lavender"
        : "rgb(" + rgbVersion.r + "," + rgbVersion.g + "," + rgbVersion.b + ")";
    let fromColor =
      this.props.lastColor === ""
        ? "lavender"
        : "rgb(" +
          rgbVesionLastColor.r +
          "," +
          rgbVesionLastColor.g +
          "," +
    ...
    return (
      <View style={styles.container}>
        ...
        <Animated.View
          style={
            this.props.title === "Current Color" ? animateValue : styles.box
          }
        />
        <Text style={{ ...styles.boxTitle, marginTop: "2%" }}>
          {this.props.color}
        </Text>
      </View>
    );
