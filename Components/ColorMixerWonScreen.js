...
class ColorMixerWonScreen extends Component {
    ...
    render() {
        ...
        return (
            <Modal style={{height: '100%', justifyContent: 'center', alignItems: 'center'}} transparent={true} isVisible={this.props.visibility} 
                            animationType={"slide"} backdropOpacity={0.8} animationInTiming={1500} backdropTransitionInTiming={1500}>
                    ...
                    <View style={{width: '90%', height: '40%', flexDirection: 'row', justifyContent:'flex-start', marginTop:'7%'}}>
                        ...
                        <View style={{height: '100%', width:'80%', flexDirection: 'row', flexWrap: 'wrap', justifyContent:'flex-start'}}>
                            {this.props.colorsNeeded.map((color, index) => {
                                return (
                                    <View key={index} style={{flexDirection:'row', marginHorizontal: '6%', marginBottom:'6%'}}>
