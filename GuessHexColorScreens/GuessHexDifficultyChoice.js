        ...
        return (
            <View style={styles.container}>
                <View style={styles.innerContainer}>
                    <TouchableOpacity style={{...styles.option, backgroundColor: Colors.tropicalYellow}}
                                      onPress={() => {
                                          this.props.navigation.navigate("GuessHexGameScreen")
                                      }}>
                        <Text style={styles.optionText}>Easy</Text>
                    </TouchableOpacity>
                    <TouchableOpacity style={{...styles.option, backgroundColor: Colors.tropicalBlue}}>
                        <Text style={styles.optionText}>Medium</Text>
                    </TouchableOpacity>
                    <TouchableOpacity style={{...styles.option, backgroundColor: Colors.tropicalRed}}>
